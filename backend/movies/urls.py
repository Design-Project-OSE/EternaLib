...
urlpatterns=[
    ...
    path('movies/comment/delete',views.delete_comment,name="Oyun Yorumlarını siler commentID"),
    ...
    path('movies/category/get',views.list_getcategory,name="categoryID alıyor tüm sahip filmleri çekiyor"),
]